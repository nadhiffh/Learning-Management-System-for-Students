    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            @if (Auth::user()->role == \App\User::ROLE_ADMIN)
                ...
                <li class="nav-item {{ Nav::isRoute('admin.class.index') }}">
                ...
                <li class="nav-item {{ Nav::isRoute('admin.schedule.index') }}">
                ...
                <li class="nav-item {{ Nav::isRoute('admin.grade.index') }}">
                ...
                <li class="nav-item {{ Nav::isRoute('admin.assignment.index') }}">
                    <a class="nav-link" href="{{ route('admin.assignment.index') }}">
                        <i class="fas fa-fw fa-plus"></i>
                        <span>{{ __('Assignment') }}</span>
                    </a>
                </li>

                <li class="nav-item {{ Nav::isRoute('admin.forum.index') }}">
            ...
            @else
                <li class="nav-item {{ Nav::isRoute('class.index') }}">
                ...
                <li class="nav-item {{ Nav::isRoute('grade.index') }}">
                ...
                <li class="nav-item {{ Nav::isRoute('assignment.index') }}">
                ...
                <li class="nav-item {{ Nav::isRoute('forum.index') }}">
